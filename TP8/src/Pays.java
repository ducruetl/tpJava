public class Pays implements Comparable<Pays> {
    ...
    public int compareTo(Pays o) {
        ...
        if (getContinent().compareTo(o.getContinent()) < 0 | (getContinent().compareTo(o.getContinent()) == 0 & getNom().compareTo(o.getNom()) < 0)) {

            return -1;

        } else if (getContinent().compareTo(o.getContinent()) == 0 & getNom().compareTo(o.getNom()) == 0) {
